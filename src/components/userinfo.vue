      ...
      <div class="right">
        <div class="detail-title">详细信息
          <i-button @click="startEdit" class="edit-btn-wrap" type="text">
            <Icon style="margin-right:5px;" type="edit"></Icon>编辑</i-button>
        </div>
        <hr class="hr">
        <div class="item">
        ...
        <div class="item">
          ...
          <span v-if="user.email">
                ...
                <i-button  v-else @click="verifyEmail" type="text" style="background:red; border:0; padding:2px 7px; color:#fff;">未验证</i-button>
              </span>
        </div>
        <div class="item">
